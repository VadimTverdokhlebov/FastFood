...
const comps = { size: "Размер", bread: "Хлеб", vegetable: "Овощи", sauce: "Соус", filling: "Начинка", };
const menuModalCategorylId = ["size", "bread", "vegetable", "sauce", "filling", "sandwichDone"];
const basket = [];

const mainJson = getJson();
...
async function showProductMenuModal(categoryId) {
    ...
    let sum = customSandwich.price + Number(getSumProductInCustomSandwich());
    ...
    showSelectedElemCustomSandwich();
}
...
function showSelectedElemCustomSandwich() {
